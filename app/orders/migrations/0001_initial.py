    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('awaiting_call', 'Ожидает звонок'), ('awaiting_service', 'Ожидает услугу'), ('paused', 'Приостановлен'), ('completed', 'Завершен'), ('cancelled', 'Отменен')], default='awaiting_call', max_length=20)),
